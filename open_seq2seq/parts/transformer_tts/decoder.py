  ...
  def __init__(self, params, training):
    ...
    for _ in range(params["num_hidden_layers"]):
      ...
      self.layers.append([
        ...
        PrePostProcessingWrapper(enc_dec_attention_layer, params, training),
        PrePostProcessingWrapper(feed_forward_network, params, training)
      ])

    self.output_normalization = LayerNormalization(params["hidden_size"])

  def __call__(self, decoder_inputs, encoder_outputs, decoder_self_attention_bias, attention_bias, cache=None):
